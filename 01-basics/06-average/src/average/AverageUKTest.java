/*
 * AverageUKTest.java 13 Sept 2024
 *
 *
...
public class AverageUKTest {
  ...
  public void testOnlyOneFloatVariableDeclared() throws IOException {
    ...
    // file)
    String filePath = "src/average/AverageUK.java";
    ...
    long floatCount = cleanedSourceCode.lines().filter(line -> line.contains("float ")).count();

    // Assert that only one float is declared
    assertEquals(1, floatCount, "There should only be one float variable declared in the AverageUK class.");
  }
